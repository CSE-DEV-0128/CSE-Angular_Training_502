# Angular Boot Camp example: query-parameters
...
**[StackBlitz for query-parameters](https://stackblitz.io/github/AngularBootCamp/query-parameters)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/query-parameters.git
cd query-parameters
npm install
npm start
```
